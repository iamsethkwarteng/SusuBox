...
export const groups: Group[] = [
  {
    ...
    rotation: [
      { position: 1, memberId: 'm2', userId: 'u2', memberName: 'Efua Mansah', date: '2026-06-01', amount: 800, state: 'completed', reliabilityScore: 94 },
      { position: 2, memberId: 'm7', userId: 'u7', memberName: 'Yaw Asante', date: '2026-06-08', amount: 800, state: 'completed', reliabilityScore: 85 },
      { position: 3, memberId: 'm6', userId: 'u6', memberName: 'Ama Osei', date: '2026-06-15', amount: 800, state: 'current', collectedCount: 6, totalCount: 8, reliabilityScore: 91 },
      { position: 4, memberId: 'm5', userId: 'u5', memberName: 'Kojo Frimpong', date: '2026-06-22', amount: 800, state: 'upcoming', reliabilityScore: 88 },
      { position: 5, memberId: 'm1', userId: 'u1', memberName: 'Kofi Mensah', date: '2026-06-29', amount: 800, state: 'upcoming', reliabilityScore: 98 },
    ],
    history: [
  ...
  },
  {
    ...
    pendingRequests: [],
    rotation: [
      { position: 10, memberId: 'u12', userId: 'u12', memberName: 'Afia Darko', date: '2026-05-14', amount: 4000, state: 'completed', reliabilityScore: 92 },
      { position: 11, memberId: 'u1', userId: 'u1', memberName: 'Kofi Mensah', date: '2026-06-14', amount: 4000, state: 'completed', reliabilityScore: 98 },
      { position: 12, memberId: 'u9', userId: 'u9', memberName: 'Emmanuel Tetteh', date: '2026-07-14', amount: 4000, state: 'current', collectedCount: 5, totalCount: 8, reliabilityScore: 96 },
      { position: 13, memberId: 'u10', userId: 'u10', memberName: 'Adjoa Boateng', date: '2026-08-14', amount: 4000, state: 'upcoming', reliabilityScore: 38 },
    ],
    history: [
  ...
  },
  {
    ...
    pendingRequests: [],
    rotation: [
      { position: 1, memberId: 'm17', userId: 'u1', memberName: 'Kofi Mensah', date: '2026-07-20', amount: 900, state: 'upcoming', reliabilityScore: 98 },
      { position: 2, memberId: 'm18', userId: 'u16', memberName: 'Abena Pokua', date: '2026-07-27', amount: 900, state: 'upcoming', reliabilityScore: 90 },
      { position: 3, memberId: 'm21', userId: 'u19', memberName: 'Ama Serwaa', date: '2026-08-03', amount: 900, state: 'upcoming', reliabilityScore: 88 },
      { position: 4, memberId: 'm20', userId: 'u18', memberName: 'Emmanuel Quaye', date: '2026-08-10', amount: 900, state: 'upcoming', reliabilityScore: 82 },
      { position: 5, memberId: 'm19', userId: 'u17', memberName: 'Yaw Darko', date: '2026-08-17', amount: 900, state: 'upcoming', reliabilityScore: 75 },
      { position: 6, memberId: 'm22', userId: 'u22', memberName: 'Akosua Agyemang', date: '2026-08-24', amount: 900, state: 'upcoming', reliabilityScore: 68 },
    ],
    history: [],
  },
];
